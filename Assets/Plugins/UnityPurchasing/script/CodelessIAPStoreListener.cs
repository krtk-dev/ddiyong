...
namespace UnityEngine.Purchasing
{
    ...
    public class CodelessIAPStoreListener : IStoreListener
    {
        ...
        public void OnInitialized(IStoreController controller, IExtensionProvider extensions)
        {
            ...
            if (!controller.products.WithID("removeads").hasReceipt)
            {
                PlayerPrefs.SetString("ADS", "false");
            }
            else
            {
                PlayerPrefs.SetString("product", controller.products.WithID("removeads").receipt);
        ...
        {
            PlayerPrefs.SetString("ADS", "false");
            PlayerPrefs.SetString("product", error.ToString());
